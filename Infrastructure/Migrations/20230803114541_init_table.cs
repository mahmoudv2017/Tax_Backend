        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxPayers_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdjustedGrossIncome = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxReturnID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxHistorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaxHistorys_TaxReturns_TaxReturnID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxHistorys_TaxReturnID",
                table: "TaxHistorys",
                column: "TaxReturnID");
